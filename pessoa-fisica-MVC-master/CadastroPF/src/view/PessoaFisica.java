...
import Controler.JbdUtil;
import Controler.pessoajdbcDAO;
...
public class PessoaFisica extends JFrame{
	...
	model.PessoaFisica2 pessoaFisica = new model.PessoaFisica2();  
	...
	public PessoaFisica(){
	    ...
	    String textoDoCombo = cmbEst .getSelectedItem().toString();
		...
		btnSalvar.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent evt){
				PessoaFisica2 coiso = new PessoaFisica2();
				
				try {
					coiso.setNome(txtNome.getText());
					coiso.setEndereco(txtEnd.getText());
					coiso.setBairro(txtBairro.getText());
					coiso.setCep(txtCep.getText());
					coiso.setCidade(txtCidade.getText());
					coiso.setTelefone(txtTel.getText());
					coiso.setCpf(txtCpf.getText());
					coiso.setRg(txtRg.getText());
					coiso.setEstado(textoDoCombo);
					coiso.setCelular(txtCel.getText());
					char escolha;
					if(rdbsexo.toString() == "Feminino" ) {
						 escolha = 'F';
					}
					else {
						 escolha = 'M';
